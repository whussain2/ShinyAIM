column(8,
    ...
    h3('On server'),
      ...
      tags$blockquote(
        ...
        br(),
        tags$p(strong('or'), "can be directly downloaded from the link given below:"),
        tags$a(href="https://zenodo.org/record/1419296/files/whussain2/ShinyAIM-v1.0.0.zip?download=1", "https://zenodo.org/record/1419296/files/whussain2/ShinyAIM-v1.0.0.zip?download=1"),
        ...
        tags$a(href="https://youtu.be/5-JLMpSiwv4", "https://youtu.be/5-JLMpSiwv4")),
         ...
         hr(),
      tags$blockquote(
        tags$p(strong('How to cite ShinyAIM:'), "Hussain W., Campbell M., Walia H., Morota G. (2018) ShinyAIM: Shiny-based Application of Interactive Manhattan Plots for Longitudinal Genome-Wide Association Studies. bioRxiv."), 
        style = "font-size: 18px"),
      hr(),
